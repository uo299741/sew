...
class Ciudad {
    ...
    getInfoSecCiudad() {
        ...
        const población = document.createElement("li");
        gentilicio.innerHTML = `<strong>Gentilicio:</strong>  ${this.#gentilicio}`;
        población.innerHTML = `<strong>Población:</strong>  ${this.#cantidadPoblacion} habitantes`;
        lista.appendChild(gentilicio);
        lista.appendChild(población);
        return lista;
    }
    ...
    procesarJSONCarrera(data){
        ...
        document.querySelector("main").append(article[0]);
    }
...
$(document).ready(function() {
    ...
    h2.textContent = circuitCity.getNombreCiudad();
    infoCiudad.appendChild(h2);
    const pais = document.createElement("p");
    pais.innerHTML = `<strong>País:</strong> ${circuitCity.getPais()}`;
    infoCiudad.appendChild(pais);
    infoCiudad.appendChild(circuitCity.getInfoSecCiudad());
    infoCiudad.appendChild(circuitCity.escribirCoordenadas());
    document.querySelector("main").appendChild(infoCiudad);
