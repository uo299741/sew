                ...
                <main>
                    <h3>Pulse un botón</h3>
                        <form action='#' method='post' name='botones'>
                            <button type='submit' name='botonArrancar'>Arrancar</button>
                            <button type='submit' name='botonParar'>Parar</button>
                            <button type='submit' name='botonMostrar'>Mostrar</button>
                        </form>
