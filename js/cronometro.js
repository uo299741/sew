...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.querySelector("[data-arrancar]")
        .addEventListener("click", () => crono.arrancar());

    document.querySelector("[data-parar]")
        .addEventListener("click", () => crono.parar());

    document.querySelector("[data-reiniciar]")
        .addEventListener("click", () => crono.reiniciar());
});